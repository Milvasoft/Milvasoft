...
namespace Milvasoft.SampleAPI.Services.Abstract
{
    ...
    public interface IAccountService
    {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        Task<IdentityResult> ChangePhoneNumberAsync(AppUser user, string newPhoneNumber, string token);
        ...
        /// <param name="user"></param>
        /// <returns></returns>
        Task<(AppUser tUser, LoginResultDTO loginResult)> ValidateUser(ILoginDTO loginDTO, AppUser user);
        ...
        /// <returns></returns>
        Task<string> GenerateTokenWithRoleAsync(AppUser user, DateTime tokenExpiredDate);
