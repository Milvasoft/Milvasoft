...
internal class ValidEfSourceForBuildFilterExpressionMethodData : IEnumerable<object[]>
{
    /// <summary>
    ...
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        var dbContextFixture = new DbContextMock<RestDbContextFixture>(nameof(FilterRequest)).GetDbContextFixture();
