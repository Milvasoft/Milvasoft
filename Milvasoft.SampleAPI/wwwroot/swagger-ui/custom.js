(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            headContent.children[1].textContent = "Ops!yon Local API";
            headContent.children[3].href = "https://opsiyon.online/docs/favicon-32x32.png";
            headContent.children[4].href = "https://opsiyon.online/docs/favicon-16x16.png";
            ...
            logo[0].children[0].src = "https://opsiyon.online/docs/favicon.ico"; //For Changing The Logo Image
