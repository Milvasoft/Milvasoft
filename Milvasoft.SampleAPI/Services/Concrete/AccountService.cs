...
namespace Milvasoft.SampleAPI.Services.Concrete
{
    ...
    public class AccountService : IAccountService
    {
        ...
        private readonly UserManager<MilvaUser> _userManager;
        private readonly SignInManager<MilvaUser> _signInManager;
        private readonly ITokenManagement _tokenManagement;
        private readonly IContextRepository<TodoAppDbContext> _contextRepository;
        ...
        public AccountService(UserManager<MilvaUser> userManager,
                              SignInManager<MilvaUser> signInManager,
                              TokenManagement tokenManagement,
                              IContextRepository<TodoAppDbContext> contextRepository,
        ...
        {
            MilvaUser userToBeSignUp = new MilvaUser
            {
        ...
        /// <param name="newPassword"></param>
        /// <returns></returns>
        public virtual async Task<IdentityResult> ChangePasswordAsync(MilvaUser user, string currentPassword, string newPassword)
        {
        ...
        /// <returns></returns>
        public virtual async Task<IdentityResult> ChangeEmailAsync(MilvaUser user, string newEmail, string token) => await _userManager.ChangeEmailAsync(user, newEmail, token).ConfigureAwait(false);
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public virtual async Task<IdentityResult> ChangePhoneNumberAsync(MilvaUser user, string newPhoneNumber, string token) => await _userManager.ChangePhoneNumberAsync(user, newPhoneNumber, token).ConfigureAwait(false);
        ...
        /// <param name="user"></param>
        /// <returns></returns>
        public virtual async Task<(MilvaUser tUser, LoginResultDTO loginResult)> ValidateUser(ILoginDTO loginDTO, MilvaUser user)
        {
            ...
            {
                _contextRepository.InitializeUpdating<MilvaUser, Guid>(user);
        ...
        /// <returns></returns>
        public virtual async Task<string> GenerateTokenWithRoleAsync(MilvaUser user, DateTime tokenExpiredDate)
        {
